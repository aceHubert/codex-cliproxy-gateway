...
const DICT = {
  zh: {
    ...
    labelCodebuddy: "CodeBuddy/WorkBuddy 兼容",
    descCodebuddy: "启用 CodeBuddy/WorkBuddy Responses 入口；upstream-only 模式下不生效。",
    codebuddyDisabledHint: "upstream-only 模式下 CodeBuddy/WorkBuddy 入口被禁用，此开关暂不生效；切回动态路由后可重新开启。",
    ...
    labelRouterMode: "路由模式",
    badgeDynamicRouting: "动态路由",
    badgePureUpstream: "纯上游转发",
    descUpstreamOnly: "cliproxy/* 转发上游，其余直通官方",
  ...
  en: {
    ...
    labelCodebuddy: "CodeBuddy/WorkBuddy Compatibility",
    descCodebuddy: "Enables the CodeBuddy/WorkBuddy Responses endpoint; inactive in upstream-only mode.",
    codebuddyDisabledHint: "CodeBuddy/WorkBuddy is disabled in upstream-only mode; this switch has no effect until you switch back to dynamic routing.",
